...
const Plan = () => {
  return (
    ...
    <div className="flex flex-col overflow-hidden  shadow-sm md:flex-row">
			<img    src="" alt="" className="h-80 rounded-lg  dark:bg-gray-500 w-full sm:aspect-video md:w-[370px]  " />
			<div className="flex flex-col justify-center flex-1 p-6 lg:pl-16  ">
				...
				<button type="button" className="self-start border px-3 py-3 hover:bg-green-900 hover:border-none" >Choose Your Plan</button>
			</div>
		</div>
    </div>
    </section>
